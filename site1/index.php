...
$x = "NARAN";
echo "I post my latest lessons to $txt " . "$x $x $x $x $x $x $x $x $x $x $x $x $x $x $x". "how do I get a complete word count of my NARANS without typing all of them in..." . str_word_count("NARAN");
echo "<br>";
