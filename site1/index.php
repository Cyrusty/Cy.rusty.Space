...
<<<<<<< HEAD
	echo  "<p> Your IP address is <strong> <a href='http://ipinfo.io/" . $_SERVER ['REMOTE_ADDR'] . "'> " . $_SERVER ['REMOTE_ADDR'] . " </a></strong></p>";
	//"<p> Your Ip address is <strong>" . $_SERVER ['REMOTE_ADDR'] . "</strong> 
	
=======
	echo "<p>" . "Your Ip address is " . "<strong>" . $_SERVER ['REMOTE_ADDR'] . "</strong>"
	 . "<a href='http://ipinfo.io/" . $_SERVER ['REMOTE_ADDR'] . "'> 1.2.3.4 </a>" . "</p>"; ?>
>>>>>>> 516cc928a1e79a16949d675cc2de3acbcc80205a
